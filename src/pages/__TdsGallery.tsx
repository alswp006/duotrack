  ...
  return (
    <>
      ...
      <Section title="TextField (variants)">
        <TextField variant="box" label="Box" placeholder="박스 타입 입력" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="line" label="Line" placeholder="라인 타입 입력" value={text} onChange={(e) => setText(e.target.value)} />
        <TextField variant="big" label="Big" placeholder="빅 타입 입력" value={text} onChange={(e) => setText(e.target.value)} />
      </Section>
